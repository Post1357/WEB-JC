document.addEventListener('DOMContentLoaded', () => {
    ...
    // Manejo de eventos de botones y tarjetas
    document.addEventListener('click', (e) => {
        // Abrir Enlaces (al hacer clic en botones de tarjetas o tarjetas de miniatura)
        const openElem = e.target.closest('.btn-open');
        if (openElem) {
            const url = openElem.getAttribute('data-url');
    ...
    // Generador de Tokens Criptográficos en tiempo real
    ...
    // Detección del tipo de conexión (Muestra un solo valor: Ethernet o Wi-Fi)
    function getConnectionType() {
        ...
        if (connection && connection.type) {
            ...
            // Evaluación basada en latencia/RTT para navegadores de escritorio
